...
class SOWERBASEEXP SwModuleBookPanel : public SwPanel
{
public:
    SwModuleBookPanel();
    SwModuleBookPanel(wxWindow *parent, wxWindowID id=wxID_ANY, const wxPoint &pos=wxDefaultPosition, const wxSize &size=wxDefaultSize, long style=wxTAB_TRAVERSAL, const wxString &name=wxPanelNameStr);
    virtual ~SwModuleBookPanel();
    ...
    wxNotebook*          ToolNotebook;
    SwFindPanel*         findPanel;
    SwModuleSearchPanel* searchPanel;
    SwViewBook*          viewBook;
    SwModuleTreeCtrl*    TocTreeCtrl;
...
class SOWERBASEEXP SwMultiModuleBookPanel : public SwPanel
{
public:
    ...
    wxNotebook*               ToolNotebook;
    SwFindPanel*              findPanel;
    SwMultiModuleSearchPanel* searchPanel;
    SwViewBook*               viewBook;
    SwModuleTreeCtrl*         TocTreeCtrl;
...
class SOWERBASEEXP SwMultiFileThMLBookPanel : public SwPanel
{
public:
    ...
    wxNotebook*                 ToolNotebook;
    SwFindPanel*                findPanel;
    SwMultiFileThMLSearchPanel* searchPanel;
    SwViewBook*                 viewBook;
    SwThMLTreeCtrl*             TocTreeCtrl;
