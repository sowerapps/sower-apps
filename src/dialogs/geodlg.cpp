...
void SwGeoDlg::BuildContent(wxWindow* parent, wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    TopTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(TopTextCtrl, wxGBPosition(1, 1), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    TopPxTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(TopPxTextCtrl, wxGBPosition(1, 2), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    BottomTextCtrl ->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(BottomTextCtrl, wxGBPosition(2, 1), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    BottomPxTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(BottomPxTextCtrl, wxGBPosition(2, 2), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    LeftTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(LeftTextCtrl, wxGBPosition(4, 1), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    LeftPxTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(LeftPxTextCtrl, wxGBPosition(4, 2), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    RightTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(RightTextCtrl, wxGBPosition(5, 1), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    RightPxTextCtrl->SetMinSize(wxSize(65, -1));
    GridBagSizer1->Add(RightPxTextCtrl, wxGBPosition(5, 2), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    GridBagSizer1->Add(RadiusTextCtrl, wxGBPosition(7, 2), wxDefaultSpan, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
